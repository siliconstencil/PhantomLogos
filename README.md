...
- **[AGENTS.md](AGENTS.md):** 14-axis memory architecture and RuFlow hiyerarşisi.
- **[IDENTITY.md](.antigravity/IDENTITY.md):** Cognitive profile of the Antigravity Architect within Phantom Logos.
- **[walkthroughs/](.antigravity/walkthroughs/):** Phase-by-phase execution history (currently 11.18.4).
...
4. **Database-First**: All persistence via Mnemosyne (SQLite/LanceDB Axis 1-14).
5. **Formal Verification**: Axis 11 `SympyVerifier` + `QWED` for zero-trust audits.
