...
1.  **[reflection_store.py](file:///D:/Hank/cognition/mnemosyne/reflection_store.py#L83)**:
    *   *Mevcut Kod*: `return sqlite3.connect(self.db_path)`
    *   *Risk*: Yansıma ve entity güncellemelerinde anında kilitlenmeye düşer.
2.  **[context_cache.py](file:///D:/Hank/src/architrave/context_cache.py#L63)**:
...
3.  **[opencode_store.py](file:///D:/Hank/src/architrave/opencode_store.py#L30)**:
    *   *Mevcut Kod*: `return sqlite3.connect(self.db_path)`
    *   *Risk*: OpenCode entegrasyonu seans sorgularken kilitlenir.
4.  **[snapshot_manager.py](file:///D:/Hank/src/lachesis/snapshot_manager.py#L43)**:
...
1.  **[temporal_store.py](file:///D:/Hank/cognition/mnemosyne/temporal_store.py#L45)**:
...
2.  **[orchestrator.py](file:///D:/Hank/src/clotho/orchestrator.py#L328)**:
