import pytest
import asyncio
from src.clotho.krisis import should_use_tier, should_call_tools
...
async def test_evaluator_async_flow():
    ...
    try:
        res = await asyncio.wait_for(evaluator.evaluate("print('hello world')", {"threshold": 0.5}), timeout=15.0)
